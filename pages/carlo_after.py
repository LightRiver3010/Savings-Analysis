...
st.header("Your Savings :money_with_wings:")
...
st.subheader("Before :chart_with_downwards_trend: vs. After :chart_with_upwards_trend:")
st.write("**Below, in red :closed_book:, is your 'before' simulation,** showing how much you were likely to spend each month before the savings. **The green :green_book: is the 'after,'** showing how much you're likely to spend after making these simple changes.")
...
st.markdown(f"Whereas before your worst case scenario was spending **\${before_top_10},** now it's only spending **\${after_top_10}**. That's a **\${(before_top_10 - after_top_10).round(2)} difference each month!** :bangbang:")
